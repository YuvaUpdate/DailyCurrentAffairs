...
export default function NewsFeed({
  ...
  // Viewability config for index update
  ...
  const renderArticle = ({ item: article }: { item: NewsArticle }) => (
    ...
    >
      ...
      <View style={styles.floatingTopNav}>
        ...
        >
          <View style={[styles.bookmarkIconContainer, (bookmarkedArticles as Set<string | number>).has(String(article.id)) && styles.bookmarkedIcon]}>
            <Text style={[styles.bookmarkIcon, (bookmarkedArticles as Set<string | number>).has(String(article.id)) && { color: '#ffffff' }]}
            >
              ♥
            </Text>
          </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        keyExtractor={(item) => `${item.id}-${selectedTab}`}
        renderItem={renderArticle}
        showsVerticalScrollIndicator={false}
        pagingEnabled   // 👈 makes it snap like Insta/TikTok
