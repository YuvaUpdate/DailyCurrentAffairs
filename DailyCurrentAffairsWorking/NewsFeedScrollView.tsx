...
export default function NewsFeed({
  ...
  // Handle scroll end - ensure it snaps to nearest article
  const handleScrollEnd = (event: any) => {
    ...
    // Force snap to the nearest article
    scrollViewRef.current?.scrollTo({
      y: clampedIndex * screenHeight,
      animated: true
    });
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Instagram-Style ScrollView with Perfect Snapping */}
      <ScrollView
        ref={scrollViewRef}
